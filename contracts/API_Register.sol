 ...
 * */
 contract API_Register is Register{
    ...
    function Execute_Function(address contract_address, bytes memory data)external Register_Authorities_Only{
   ...
   /*GETTER*/
    ...
    function Get_Functions_Fy_Selector(address contract_address, bytes4 function_selector) external view returns(uint index, Receipt[] memory receipts){
